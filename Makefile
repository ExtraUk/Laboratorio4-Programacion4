main: main.cpp DTFecha.o DTUsuario.o DTCliente.o DTVendedor.o TipoObjeto.o DTProducto.o DTIdYCant.o DTPromo.o DTNotificacion.o DTDetalleCompra.o Usuario.o Producto.o CompraProducto.o Compra.o Cliente.o Vendedor.o Promocion.o Comentario.o DetalleCompra.o ControladorComentario.o ControladorProducto.o ControladorCompra.o ManejadorPromocion.o ControladorUsuario.o Fabrica.o
	g++ -o main main.cpp DTFecha.o DTUsuario.o DTCliente.o DTVendedor.o TipoObjeto.o DTProducto.o DTIdYCant.o DTPromo.o DTNotificacion.o DTDetalleCompra.o Usuario.o Producto.o CompraProducto.o Compra.o Cliente.o Vendedor.o Promocion.o Comentario.o DetalleCompra.o ControladorComentario.o ControladorProducto.o ControladorCompra.o ManejadorPromocion.o ControladorUsuario.o Fabrica.o
